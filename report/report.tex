...
\buecedefinitions%
        ...
        {Nov.\ 18, 2020}
        {2020-1} % Number of the report (four year digits and number)
...
% mode.
% ------------------------------------------------------
\tableofcontents\clearpage%\bueceemptypage
\listoffigures\clearpage%\bueceemptypage
\listoftables\clearpage%\bueceemptypage
